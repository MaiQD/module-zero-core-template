...
{
    public abstract class QuizWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QuizWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QuizWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QuizDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QuizDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QuizDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QuizDbContext, Task<T>> func)
        {
            T result;
