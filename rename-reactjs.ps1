...
Copy-Item -Recurse .\reactjs\ .\$newRoot\
...
$reactjsFolder = (Get-Item -Path "./$newRoot/reactjs/" -Verbose).FullName
...
Rename -TargetFolder $reactjsFolder -PlaceHolderCompanyName $oldCompanyName -PlaceHolderProjectName $oldProjectName -NewCompanyName $newCompanyName -NewProjectName $newProjectName
